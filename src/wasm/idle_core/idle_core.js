...
export class WasmSimulation {
    ...
    build_at(kind, x, y) {
        ...
        const ret = wasm.wasmsimulation_build_at(this.__wbg_ptr, ptr0, len0, x, y);
        if (ret[2]) {
     ...
     */
    snapshot() {
        const ret = wasm.wasmsimulation_snapshot(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    tick() {
        const ret = wasm.wasmsimulation_tick(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('idle_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
